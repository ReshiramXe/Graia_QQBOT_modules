...
from modules.config_loader import get_db_config, get_api_keys
...
VOICE_FILE = COOLDOWN_CONFIG.get('voice_file', 'data/voices/1553708427.mp3')

# 管理员ID（不受冷却限制）
ADMIN_USER_ID = 1980983217
